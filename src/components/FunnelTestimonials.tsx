    ...
    <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
      ...
      <div key={index} className="bg-white p-6 rounded-xl border border-muted hover:border-primary transition-all hover:shadow-lg">
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="bg-secondary/10 p-2 rounded-lg" style={{ backgroundColor: "#f3f4f6", backgroundImage: "none" }}>
              <DollarSign className="w-5 h-5 text-secondary" style={{ backgroundImage: "none", backgroundColor: "transparent" }} />
            </div>
          </div>
